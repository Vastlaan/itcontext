		...
		<div className='responsive'>
			<div className='responsive__description'>
				...
				<p className='responsive__description--para'>
					In de wereld bestaan meer dan 35 milijard apparaten die met Internet kunnen verbinden. Laptops, PC's, tablets, mobieltjes - bijna idereen maakt dagelijks gebruik van een van die apparaten. 
